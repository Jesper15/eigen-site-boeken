...
CREATE TABLE IF NOT EXISTS `boeken`.`boek_has_schrijver` (
  ...
  CONSTRAINT `fk_boek_has_schrijver_schrijver1`
    ...
    REFERENCES `boeken`.`schrijver` (`schrijversid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
